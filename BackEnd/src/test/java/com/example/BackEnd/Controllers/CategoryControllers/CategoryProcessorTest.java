...
//        when(permissions.checkToken(authorizationHeader)).thenReturn(true);
//        when(permissions.checkAdmin(token)).thenReturn(true);
//        doNothing().when(categoryService).editCategory(any(), any());
//
//        // Act
//        ResponseEntity<String> result = categoryProcessor.editCategory(jsonString, image, authorizationHeader);
//
//        // Assert
//        assertEquals(HttpStatus.OK, result.getStatusCode());
//
...
//        when(permissions.checkToken(authorizationHeader)).thenReturn(true);
//        when(permissions.checkAdmin(token)).thenReturn(true);
//        doThrow(new RuntimeException("Error editing category")).when(categoryService).editCategory(any(), any());
//
//        // Act
//        ResponseEntity<String> result = categoryProcessor.editCategory(jsonString, image, authorizationHeader);
//
